...
import { Layers, ChevronLeft, ChevronRight, LogOut } from 'lucide-react'
...
export default function Sidebar({ navItems, isCollapsed, isMobileOpen, onToggleCollapse, onCloseMobile }) {
  ...
  const sidebarContent = (
    <div className="flex h-full flex-col">
      ...
      {/* ── User info + logout ────────────────────────────── */}
      <div className="border-t border-slate-400 p-3 dark:border-slate-800">
        {!isCollapsed ? (
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="shrink-0 rounded-lg p-1.5 text-slate-700 hover:bg-slate-100 hover:text-red-500 dark:hover:bg-slate-800"
              aria-label="Logout"
            >
